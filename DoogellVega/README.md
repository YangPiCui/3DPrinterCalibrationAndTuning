...
Instruction is based on the Cura Slicer.  
a temporary value = 0.1;  //comments  
> Filament Diameter = 1.75mm; // a permanent value 


## 0. Calibrate Printer and Set Independent Slicer Parameters
### 0.0 Bed Levelling
0. Set the hotend and the bed at their intended printing temperatures. 
1. Level the print bed against the print head with a strip of A4 paper (usually 0.1mm thick).
2. Level the entire printer with a bubble leveler placed on the print bed.

### 0.1 Acquire Printer Specifications
...
Default steps/mm X&Y = 80; Z = 400;  //(Machine LCD screen under "Advanced Settings")   
...
### 0.4 Calculate Printer Max Mechanical Speed
...
### 0.6 Set Independent Slicer Parameters 

...
Calibrate upon if filament diameter changes.  
Remove the hot end.  
...
> Printing Temperature = 205 Celsius;  
> Default Build Plate Temperature = 0;  //Heat bed for initial layer only.  
> Build Plate Temperature Initial Layer = 70;  //[reference](https://all3dp.com/2/the-best-pla-print-temperature-how-to-achieve-it/)  | [Correct elephant foot and print edge bending.]  
...
> Retraction Speed = 24mm/s;  
> Z Hop When Retracted = True;  
> Z Hop Only Over Printed Parts = True;  //set to false to improve this test.
> Z Hop Height = 3.6mm; //a multiple of the Z step size (0.04mm). 
> Lift Head = True; 
...
[Tolerance Test](https://www.thingiverse.com/thing:2006297)
